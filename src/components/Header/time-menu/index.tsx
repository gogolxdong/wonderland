...
function TimeMenu() {
    ...
    const sOHM_ADDRESS = addresses.sOHM_ADDRESS;
    const OHM_ADDRESS = addresses.OHM_ADDRESS;
                ...
                {({ TransitionProps }) => (
                    <Fade {...TransitionProps} timeout={200}>
                        <div className="tooltip">
                            <Link className="tooltip-item" href={`https://www.traderjoexyz.com/#/trade?inputCurrency=&outputCurrency=${OHM_ADDRESS}`} target="_blank">
                            ...
                            {isEthereumAPIAvailable && (
                                <div className="add-tokens">
                                    ...
                                    <div className="divider" />
                                    <div className="tooltip-item" onClick={addTokenToWallet("LWH", OHM_ADDRESS)}>
                                        <p>LWH</p>
                                    </div>
                                    <div className="tooltip-item" onClick={addTokenToWallet("sLWH", sOHM_ADDRESS)}>
                                        <p>sLWH</p>
                                    </div>
                                </div>
                            )}
